...
urlpatterns = [
    ...
    path('super/orgs/<slug:org_slug>/ban/', views.super_ban_org_view, name='super_ban_org'),
    path('super/orgs/<slug:org_slug>/unban/', views.super_unban_org_view, name='super_unban_org'),
    path('super/orgs/<slug:org_slug>/delete/', views.super_delete_org_view, name='super_delete_org'),
